...
>(({ className, variant = 'default', ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(
        'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-4 transition-all',
        ...
        {
          'border-gray-700 bg-surface-100': variant === 'default',
          'border-green-500/20 bg-green-500/10': variant === 'success',
          'border-red-500/20 bg-red-500/10': variant === 'error',
        },
        className
      )}
      {...props}
...
type ToastActionElement = ReactElement<typeof ToastPrimitives.Action>
